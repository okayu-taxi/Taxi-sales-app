...
const CalDay = memo(({ day, isToday, isClosing, state, dow, calYear, calMonth, onToggle }) => {
  ...
  return (
    <button
      ...
      style={{ border: isClosing ? "2px solid #c8900a" : "2px solid transparent", borderRadius: 4, boxSizing: "border-box", padding: "2px 0", cursor: "pointer", background: "transparent", display: "flex", flexDirection: "column", alignItems: "center", gap: 2 }}
    >
